      ...
      <form className="w-full mx-3 my-3 bg-[#182237] outline-none">
        <section className="w-full md:py-2">
          <div className="flex md:justify-between md:space-x-5 my-3 mx-3 flex-col md:flex-row gap-2 items-center md:items-start text-sm">
            <input type="text" placeholder='username' className="bg-[#0c162c] py-4 rounded-md px-3 w-96 mt-2 md:mt-0" />
            <input type="email" placeholder='email'className="bg-[#0c162c]  py-4 rounded-md px-3 w-96"/>
          </div>
          ...
          <input type="text"  placeholder='phone'  className="bg-[#0c162c]  py-4 rounded-md px-3 w-96"/>
          </div>
        ...
        <div className="flex flex-col items-center justify-center md:mx-3">
          <textarea name="" id="" rows="10" placeholder='address' className="py-3 bg-[#0c162c] md:w-full px-3 md:mx-3 rounded-md mt-3 md:mt-0 w-96"/>
